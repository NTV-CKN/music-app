 ...
 * Use the [SearchSongHistoryFragment.newInstance] factory method to
...
class SearchSongHistoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SearchSongHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearchSongHistoryFragment().apply {
